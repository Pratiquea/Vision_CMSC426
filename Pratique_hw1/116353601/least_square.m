...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 				Line fitting for DATASET 1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%% Using Linear regression for data1
format long
%for data_1
B = inv(X_1.'*X_1)*X_1.'*Y_1;  % can also be written as B = X_1\Y_1;
y_cal = B*X_1;
% figure('Name','linear regression using backslash');
figure('Name','Line fitting for DATASET 1');
subplot(3,1,1);
plot(X_1,Y_1,'o');
axis([-150 150 -150 150]);
hold on
plot(X_1,y_cal,'LineWidth',2);
title('Using Linear Regression {\color{red}Best(computationaly inexpensive)}');
hold off

%%%%%%%%%%%%%%%%%%%% Using Regularization for DATA1
...
% for i = 1:max(size(lambda))
	...
	title('Using Regularization {\color{red} Second Best}');
	hold off;
% end
...
title('Using RANSAC {\color{blue} Robust but computationaly EXPENSIVE}');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%				  Line fitting for DATASET 2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

figure('Name','Line fitting for DATASET 2');
%%%%%%%%%%%%%%%%%%%% for Linear Regression for data_2
B = X_2\Y_2;
y_cal = B*X_2;
subplot(3,1,1);
plot(X_2,Y_2,'o');
...
title('Using Linear Regression {\color{blue}Inaccurate}');
hold off

%%%%%%%%%%%%%%%%%%%% Regularization for data_2
lambda = -300000;
...
title('Using Regularization {\color{red} Best for dataset 2 (computationaly inexpensive)}');
hold off
...
title('Using RANSAC {\color{red}Second Best}');


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%				  Line fitting for DATASET 3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

figure('Name', 'Line fitting for Dataset 3');
%%%%%%%%%%%%%%%%%%%% Linear Regression for data_3
B = X_3\Y_3;
y_cal = B*X_3;
subplot(3,1,1);
plot(X_3,Y_3,'o');
...
title('Using Regularization {\color{blue}Inaccurate}');
hold off
% {\color{red}}
%%%%%%%%%%%%%%%%%%%% RANSAC for data_3
...
title('Using RANSAC {\color{red}Best, Robust for noisy dataset}');
