...
scatter(v1,v2);
hold on;
x1 = [Evec_1(1,1),-Evec_1(1,1)]*sqrt(Eval_1(1,1));
y1 = [Evec_1(2,1),-Evec_1(2,1)]*sqrt(Eval_1(1,1));

x2 = [Evec_1(1,2),-Evec_1(1,2)]*sqrt(Eval_1(2,2));
y2 = [Evec_1(2,2),-Evec_1(2,2)]*sqrt(Eval_1(2,2));
...
hold on;
axis([-200,200,-200,200]);
x1 = [Evec_2(1,1),-Evec_2(1,1)]*sqrt(Eval_2(1,1));
y1 = [Evec_2(2,1),-Evec_2(2,1)]*sqrt(Eval_2(1,1));

x2 = [Evec_2(1,2),-Evec_2(1,2)]*sqrt(Eval_2(2,2));
y2 = [Evec_2(2,2),-Evec_2(2,2)]*sqrt(Eval_2(2,2));
plot(x1,y1,'LineWidth',3);
plot(x2,y2,'LineWidth',3);
hold off;
...
hold on;
axis([-200,200,-200,200]);
x1 = [Evec_3(1,1),-Evec_3(1,1)]*sqrt(Eval_3(1,1));
y1 = [Evec_3(2,1),-Evec_3(2,1)]*sqrt(Eval_3(1,1));

x2 = [Evec_3(1,2),-Evec_3(1,2)]*sqrt(Eval_3(2,2));
y2 = [Evec_3(2,2),-Evec_3(2,2)]*sqrt(Eval_3(2,2));
plot(x1,y1,'LineWidth',3);
plot(x2,y2,'LineWidth',3);
hold off;
